...
final class Plugin {
	 ...
	 * @access private
	 * @static
	 * @var \NjHurtLaw_Sight_Addon\Plugin The single instance of the class.
	 */
	...
	public function custom_categories( $elements_manager ) {
		...
		$elements_manager->add_category(
			'njhurtlaw',
			[
				'title' => esc_html__( 'NjHurtLaw', 'njhurtlaw-addon' ),
				'icon' => 'fa fa-plug',
			]
		);
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/njhurtlaw-banner.php' );

		$widgets_manager->register( new \NjHurtLaw_Sight_Addon\NjHurtLaw_Banner() );
